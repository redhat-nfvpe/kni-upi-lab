...
resource "matchbox_profile" "worker" {
  ...
  args = flatten([
    ...
    "(var.worker_nodes[count.index]["provisioning_interface"] != "" ? "ip=${var.worker_nodes[count.index]["provisioning_interface"]}:dhcp" : " ")",
    "(var.worker_nodes[count.index]["baremetal_interface"] != "" ? "ip=${var.worker_nodes[count.index]["baremetal_interface"]}:dhcp" : " ")",
  ])
