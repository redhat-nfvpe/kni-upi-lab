...
MANIFEST_CHECK_init() {
    ...
    MANIFEST_CHECK[BareMetalHost.req.spec.bmc.address]="ipmi://([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(:[0-9]*)?$)"
    ...
    MANIFEST_CHECK[install-config.req.platform.hosts.[0-9]+.bmc.address]="ipmi://([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(:[0-9]*)?$)"
    MANIFEST_CHECK[install-config.req.platform.hosts.[0-9]+.bmc.credentialsName]="$regex_filename"
    MANIFEST_CHECK[install-config.opt.platform.hosts.[0-9]+.osProfile.type]="(rhel7|rhel8|centos7|centos8|rhcos)"
...
#     [BareMetalHost.req.spec.bmc.address]="ipmi://([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(:[0-9]*)?$)"
...
#     [install-config.req.platform.hosts.[0-9]+.bmc.address]="ipmi://([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}(:[0-9]*)?$)"
